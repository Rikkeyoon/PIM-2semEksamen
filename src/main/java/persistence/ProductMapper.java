    ...
    public void create(Product product) throws CommandException {
        ...
        try {
            ...
            String insertSql = "INSERT INTO products "
                    + "(item_number, name, description, category_name) VALUES"
                    + "(?, ?, ?, ?)";
    ...
    public TemporaryProduct getProduct(int id) throws CommandException {
        ...
        try {
            ...
            while (result.next()) {
                ...
                tempProduct = new TemporaryProduct(id, itemnumber, name, description,
                        categoryname, null);
            }
...
@Override
        ...
        try {
            ...
            while (result.next()) {
                ...
                if (product != null) {
                    ...
                    product = new TemporaryProduct(id, itemnumber, name, description, categoryname,
    ...
    public void update(Product product) throws CommandException {
        ...
        try {
            ...
            pstmt.setInt(5, product.getItemnumber);
